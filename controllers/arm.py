...
class Setpoints:
    PREPARE_PICKUP_CONE = Setpoint(math.radians(-175), MIN_EXTENSION)
    PICKUP_CONE = Setpoint(math.radians(-175), MIN_EXTENSION + 0.15)
    HANDOFF = Setpoint(math.radians(42.5), 0.93)
