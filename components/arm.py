...
class Arm:
    ...
    GRAVITY_FEED_FORWARD = 1
    GRAVITY_EXTENSION_FEED_FORWARD = 1
    MAX_EXTENSION = 1
    extended = 0
    ref = 0
    ...
    def __init__(self):
        self.motor = rev.CANSparkMax(
            ids.CanIds.Arm.rotation_1, rev.CANSparkMax.MotorType.kBrushless
        )
    ...
    def setup(self) -> None:
        self.controller.setSmartMotionAccelStrategy(
